...
public class LegendException : OfficeGraphBiffRecord
{
    ...
    ///     <list>
    ///         <item>
    ///             In a chart where the legend contains legend entries for the series and trendlines, this field MUST be
    ///             0xFFFF. This record specifies the legend entry of the series or trendline that contains this record.
    ///         </item>
    ///         <item>
    ///             In a chart where the legend contains legend entries for each data point in the chart, this field
    ///             specifies the zero-based index of a legend entry in the legend, where 0x0000 is the legend entry for the
    ///             first data point in the series.
    ///         </item>
    ///         <item>
    ///             In a chart with a surface chart group, this field specifies the zero-based index of a legend entry in the
    ///             legend, where 0x0000 is the legend entry for the lowest band of the surface chart group.
    ///         </item>
    ///     </list>
    /// </summary>
    public ushort iss;
        ...
        : base(reader, id, length)
    {
        ...
        iss = reader.ReadUInt16();
        var flags = reader.ReadUInt16();
        fDeleted = Utils.BitmaskToBool(flags, 0x1);
        fLabel = Utils.BitmaskToBool(flags, 0x2);
