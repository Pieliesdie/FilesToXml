...
public class PicF : OfficeGraphBiffRecord
{
        ...
        : base(reader, id, length)
    {
        ...
        ptyp = (LayoutType)reader.ReadInt16();
        reader.ReadBytes(2); //unused
        var flags = reader.ReadUInt16();
        // first 9 bits are reserved
        fTopBottom = Utils.BitmaskToBool(flags, 0x200);
        fBackFront = Utils.BitmaskToBool(flags, 0x400);
        fSide = Utils.BitmaskToBool(flags, 0x800);
        numScale = reader.ReadDouble();
