...
public class CatSerRange : OfficeGraphBiffRecord
{
    ...
    /// <summary>
    ///     A bit that specifies whether the value axis crosses this axis at the last category (3), the last series, or the
    ///     maximum date.
    /// </summary>
        ...
        : base(reader, id, length)
    {
        ...
        catCross = reader.ReadInt16();
        catLabel = reader.ReadInt16();
        catMark = reader.ReadInt16();
        
        var flags = reader.ReadUInt16();
        fBetween = Utils.BitmaskToBool(flags, 0x0001);
        fMaxCross = Utils.BitmaskToBool(flags, 0x0002);
        fReverse = Utils.BitmaskToBool(flags, 0x0004);
