...
public class Chart3D : OfficeGraphBiffRecord
{
    ...
    public short anRot;
    /// <summary>
    ///     A bit that specifies whether the height of the 3-D plot area is automatically determined. If fNotPieChart is 0 then
    ///     this MUST be Custom.
    /// </summary>
        ...
        : base(reader, id, length)
    {
        ...
        anRot = reader.ReadInt16();
        anElev = reader.ReadInt16();
        pcDist = reader.ReadInt16();
        pcHeight = reader.ReadUInt16();
        pcDepth = reader.ReadInt16();
        pcGap = reader.ReadUInt16();
        
        var flags = reader.ReadUInt16();
        fPerspective = Utils.BitmaskToBool(flags, 0x0001);
        fCluster = Utils.BitmaskToBool(flags, 0x0002);
        f3DScaling = (ScalingType)Utils.BitmaskToUInt16(flags, 0x0004);
        // 0x0008 is skipped
        fNotPieChart = Utils.BitmaskToBool(flags, 0x0010);
        fWalls2D = Utils.BitmaskToBool(flags, 0x0020);
