...
public class CatLab : OfficeGraphBiffRecord
{
        ...
        : base(reader, id, length)
    {
        ...
        frtHeaderOld = reader.ReadUInt32();
        wOffset = reader.ReadUInt16();
        at = (Alignment)reader.ReadUInt16();
        cAutoCatLabelReal = (CatLabelType)Utils.BitmaskToUInt16(reader.ReadUInt16(), 0x0001);
