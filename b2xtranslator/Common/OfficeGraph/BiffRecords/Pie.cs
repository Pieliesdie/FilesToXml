...
/// </summary>
[OfficeGraphBiffRecord(GraphRecordNumber.Pie)]
public class Pie : OfficeGraphBiffRecord
{
        ...
        : base(reader, id, length)
    {
        ...
        anStart = reader.ReadUInt16();
        pcDonut = reader.ReadUInt16();
        var flags = reader.ReadUInt16();
        fHasShadow = Utils.BitmaskToBool(flags, 0x1);
        fShowLdrLines = Utils.BitmaskToBool(flags, 0x2);
