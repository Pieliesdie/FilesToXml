...
public class DefaultText : OfficeGraphBiffRecord
{
    ...
    ///     0x0002      Format all Text records in the chart where the value of fScalable of the associated FontInfo structure
    ///     equals 0.
    ///     0x0003      Format all Text records in the chart where the value of fScalable of the associated FontInfo structure
    ///     equals 1.
    /// </summary>
        ...
        : base(reader, id, length)
    {
        ...
        defaultTextId = (DefaultTextType)reader.ReadUInt16();
