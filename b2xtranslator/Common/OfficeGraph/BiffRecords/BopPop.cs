...
/// <summary>
///     This record specifies that the chart group is a bar of pie chart group or a pie of pie chart group and specifies
///     the chart group attributes.
/// </summary>
[OfficeGraphBiffRecord(GraphRecordNumber.BopPop)]
public class BopPop : OfficeGraphBiffRecord
{
    ...
    /// <summary>
    ///     An unsigned integer that specifies whether this chart group is a bar of pie chart group or a pie of pie chart
    ///     group.
    /// </summary>
    public Subtype pst;
    /// <summary>
        ...
        : base(reader, id, length)
    {
        ...
        pst = (Subtype)reader.ReadByte();
        fAutoSplit = !(reader.ReadByte() == 0x0);
        split = (SplitType)reader.ReadUInt16();
        iSplitPos = reader.ReadInt16();
        pcSplitPercent = reader.ReadInt16();
        pcPie2Size = reader.ReadInt16();
        pcGap = reader.ReadInt16();
        numSplitValue = reader.ReadDouble();
        fHasShadow = Utils.BitmaskToBool(reader.ReadUInt16(), 0x0001);
