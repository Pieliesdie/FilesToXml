...
public class Bar : OfficeGraphBiffRecord
{
        ...
        : base(reader, id, length)
    {
        ...
        pcOverlap = reader.ReadInt16();
        pcGap = reader.ReadUInt16();
        
        var flags = reader.ReadUInt16();
        fTranspose = Utils.BitmaskToBool(flags, 0x1);
        fStacked = Utils.BitmaskToBool(flags, 0x2);
        f100 = Utils.BitmaskToBool(flags, 0x4);
        fHasShadow = Utils.BitmaskToBool(flags, 0x8);
