...
///     Refer to the data label overview for additional information on how this record is used and when this record is
///     ignored.
/// </summary>
...
public class AttachedLabel : OfficeGraphBiffRecord
{
        ...
        : base(reader, id, length)
    {
        ...
        fShowValue = Utils.BitmaskToBool(flags, 0x1);
        fShowPercent = Utils.BitmaskToBool(flags, 0x2);
        fShowLabelAndPerc = Utils.BitmaskToBool(flags, 0x4);
        // Note: bit mask 0x8 is skipped
        fShowLabel = Utils.BitmaskToBool(flags, 0x10);
        fShowBubbleSizes = Utils.BitmaskToBool(flags, 0x20);
        fShowSeriesName = Utils.BitmaskToBool(flags, 0x40);
