...
public class YMult : OfficeGraphBiffRecord
{
        ...
        : base(reader, id, length)
    {
        ...
        axmid = (AxisMultiplier)reader.ReadInt16();
        numLabelMultiplier = reader.ReadDouble();
        
        var flags = reader.ReadUInt16();
        fAutoShowMultiplier = Utils.BitmaskToBool(flags, 0x0002);
        fBeingEdited = Utils.BitmaskToBool(flags, 0x0004);
